...
def parse():
    ...
    parser.add_argument('-nt', '--n_trash_qubit',dest= 'n_trash_qubit',type=int, default=1)      # option that takes a value
    ...
    parser.add_argument('-jx','--jax',dest='jax' ,action='store_false')
